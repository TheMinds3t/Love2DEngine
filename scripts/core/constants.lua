...
C_LOGGER_LEVEL_PREFIXES = {
    [C_LOGGER_LEVELS.ERROR] = "### ERROR ### ",
    [C_LOGGER_LEVELS.CORE] = "CORE: ",
    [C_LOGGER_LEVELS.INFO] = "INFO: ",
    [C_LOGGER_LEVELS.DEBUG] = "DEBUG: ",
}
...
C_CAMERA_MOUSE_CAPTURE_SCALAR = 0.225

C_AUDIO_MAX_SFX_SOURCES = 16

C_LEVEL_TILE_SIZE = 48
C_LEVEL_FLOOR_LIP_SIZE = 5

C_PHYSICS_ACTIVATE_RAYCHECK_FREQUENCY = 15