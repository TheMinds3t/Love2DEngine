...
return
{
	animations = 
	{
		fly =
		{
			...
			frames = {
				{image="ENEMY_BAT",dimensions={x=0,y=0,w=32,h=32}, frames=45, x_pos = 0, y_pos = 0, x_pivot = 16, y_pivot = 16, x_scale = 1, y_scale = 2, rotate = 0, color=C_COLOR_WHITE, interp=C_RENDER_INTERPOLATE_TYPE.NORMAL},
				{image="ENEMY_BAT",dimensions={x=32,y=0,w=32,h=32}, frames=60, x_pos = 0, y_pos = 0, x_pivot = 16, y_pivot = 16, x_scale = 3, y_scale = 1, rotate = 0, color=C_COLOR_WHITE, interp=C_RENDER_INTERPOLATE_TYPE.NORMAL},
				{image="ENEMY_BAT",dimensions={x=64,y=0,w=32,h=32}, frames=15, x_pos = 0, y_pos = 0, x_pivot = 16, y_pivot = 16, x_scale = 5, y_scale = 3, rotate = 0, color=C_COLOR_WHITE, interp=C_RENDER_INTERPOLATE_TYPE.NORMAL},
			},
		},
		attack =
		{
