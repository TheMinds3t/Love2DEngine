...
return
{
	animations = 
	{
		...
		effect =
		{
			...
			no_loop = true,
			frames = {
				{image="BULLET_ATLAS", dimensions={x=32,y=0,w=16,h=16}, frames=2, x_pos = 0, y_pos = 0, x_pivot = 8, y_pivot = 8, x_scale = 1, y_scale = 1, rotate = 0, color=C_COLOR_WHITE, interp=C_RENDER_INTERPOLATE_TYPE.NORMAL},
				{image="BULLET_ATLAS", dimensions={x=48,y=0,w=16,h=16}, frames=2, x_pos = 0, y_pos = 0, x_pivot = 8, y_pivot = 8, x_scale = 1.25, y_scale = 0.8, rotate = 0, color=C_COLOR_WHITE, interp=C_RENDER_INTERPOLATE_TYPE.NORMAL},
				{image="BULLET_ATLAS", dimensions={x=32,y=16,w=16,h=16}, frames=2, x_pos = 0, y_pos = 0, x_pivot = 8, y_pivot = 8, x_scale = 1.5, y_scale = 0.6, rotate = 0, color=C_COLOR_WHITE, interp=C_RENDER_INTERPOLATE_TYPE.NORMAL},
				{image="BULLET_ATLAS", dimensions={x=48,y=16,w=16,h=16}, frames=2, x_pos = 0, y_pos = 0, x_pivot = 8, y_pivot = 8, x_scale = 1.75, y_scale = 0.4, rotate = 0, color=C_COLOR_WHITE, interp=C_RENDER_INTERPOLATE_TYPE.NORMAL},
